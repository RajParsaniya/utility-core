...
public class BaseHandler implements IBaseHandler {
    ...
    @Override
    public void catchable(Class<? extends Exception> exceptionClass) {
        this.catchableExceptions.add(exceptionClass);
    }

    @Override
    public void catchable(Set<Class<? extends Exception>> exceptionClasses) {
        this.catchableExceptions.addAll(exceptionClasses);
    }

    @Override
    public void throwable(Supplier<? extends RuntimeException> exception) {
        this.supplierException = exception;
    }

    @Override
    public void throwable(Function<Exception, ? extends RuntimeException> exception) {
